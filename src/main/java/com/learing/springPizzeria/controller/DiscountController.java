...
public class DiscountController {
  ...
  public String create(@RequestParam("pizzaId") Integer pizzaId, Model model) {
    ...
    discount.setDiscountPizza(pizza.get());
  ...
  public String update(@Valid @ModelAttribute("discount") Discount formDiscount, BindingResult bindingResult) {
    ...
    return "redirect:/pizza/" + formDiscount.getDiscountPizza().getId();
  }
  ...
  public String update(@PathVariable Integer id,
    ...
    return "redirect:/books/" + formDiscount.getDiscountPizza().getId();
  }
  ...
  public String delete(@PathVariable Integer id) {
    ...
    return "redirect:/books/" + discountToDelete.get().getDiscountPizza().getId();
  }
}
